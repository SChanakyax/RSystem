...
public class additem {
	...
	public String getD1() {
		...
		try {
			...
			date = df.format(dateChooser.getDate());
				...
				JOptionPane.showMessageDialog(null, "Please fill manufactured date");
	...
	public String getD2() {
		...
		try {
			...
			date = df.format(dateChooser_1.getDate());
			}catch(Exception e1 ) {
				JOptionPane.showMessageDialog(null, "Please fill manufactured date");
	...
	public String getD3() {
		...
		try {
			...
			date = df.format(dateChooser_2.getDate());
			}catch(Exception e1 ) {
				JOptionPane.showMessageDialog(null, "Please fill manufactured date");
	...
	public void checkDates() {
		try {
			...
			SimpleDateFormat exp = new SimpleDateFormat("dd/MM/yyyy");
			//pdate.setText(exp.format(dateChooser_2.getDate()));
			...
			try {	
					Date date1 = exp.parse(getD1());
					Date date2 = exp.parse(getD2());
					Date date3 = exp.parse(getD3());

					//System.out.println(manu);
					
				//	Date purc = pur.parse(pur.format(dateChooser.getDate()));

				//	Date expi = exp.parse(exp.format(dateChooser.getDate()));
			//		System.out.println(manu+ "   " + purc + "  " + expi +  "  ");

					
					
					if(date1.compareTo(date3)< 0) {
						System.out.println("manu date is less than exp date expired");
				//		JOptionPane.showMessageDialog(null, "Please check the Manufactured date");

					}else if(date1.compareTo(date2)<0) {
						System.out.println("manu date is less than pur date");
						JOptionPane.showMessageDialog(null, " Please check the dates correctly");

					}else if(date1.compareTo(date2)>0) {
							System.out.println("manu date is greater than purs date");
							JOptionPane.showMessageDialog(null, " Please check the Expiry or Manufactured dates correctly");

					}else {
						JOptionPane.showMessageDialog(null, " Wrong Date inputs check again..");
					}
	...
	private void initialize() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    String query = "INSERT INTO item values('" + ItemNumber + "','" + ItemName + "','" + 	Type + "','" +
                    ...
                    JOptionPane.showMessageDialog(null, "This item number alredy exist");
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				System.out.println("manu fac "+df.format(dateChooser.getDate()));
				}catch(Exception e1 ) {
					JOptionPane.showMessageDialog(null, "Please fill manufactured date");
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("purchases "+ da.format(dateChooser.getDate()));
				}catch(Exception e1 ) {
					JOptionPane.showMessageDialog(null, "Please fill purchase date");
		...
		btnNewButton_3_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("expiry "+ dc.format(dateChooser.getDate()));
				}catch(Exception e1 ) {
					JOptionPane.showMessageDialog(null, "Please fill expiry date");
